...
// decimal_places is 2 on the network, so this high-precision sample can't come
// from a real BigInt amount. Formatting the literal through the shared helper
// keeps the preview identical to production output.
