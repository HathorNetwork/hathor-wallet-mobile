...
1. **Auto switch to multi with tx outiside index 0**
    ...
    1. [ ] Back again to single adress and save. The wallet should restart. We should be able to change the mode as we want while any transaction arrives in another address different than the index 0.
...
1. **Multi address mode**
    ...
    1. [ ] 1. [ ] Call a reown send transaction method, the caller edit option should be enabled